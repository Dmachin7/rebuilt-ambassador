    ...
    <div>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .tag-title { font-weight: 700; font-size: 13pt; color: #1e3a2f; line-height: 1.15; }
        .tag-line { font-size: 10pt; color: #333; margin-top: 3px; }
        .tag-contents { font-size: 10pt; color: #333; margin-top: 4px; font-weight: 600; }
        .tag-date { font-size: 9pt; color: #666; margin-top: 6px; }
      `}</style>
